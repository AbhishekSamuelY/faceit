					...
					<div class="row-main card">
						...
						<div class="message-col">
							...
							<div class="message-bottom">
								<!-- delete button -->
								<a href="deletewallit?wallitId=${wallit.sl}"><img
				...
				<div class="pagination">
					<jtags:if test="${totalPages > 0}">
						...
						<jtags:if test="${pageNumber >= 1}">
							<a class="pages text" href="paginateWallIt?pageNumber=1">First</a>
						</jtags:if>
						...
						<jtags:forEach begin="1" end="${totalPages}" var="i">
							<jtags:choose>
								<jtags:when test="${i!=pageNumber}">
									<a class="pages inactive" href="paginateWallIt?pageNumber=${i}">${i}</a>
								</jtags:when>
								<jtags:otherwise>
						...
						<jtags:if test="${pageNumber <= totalPages}">
							<a class="pages text"
								href="paginateWallIt?pageNumber=${totalPages}">Last</a>
						</jtags:if>
					</jtags:if>
				</div>
			</div>
